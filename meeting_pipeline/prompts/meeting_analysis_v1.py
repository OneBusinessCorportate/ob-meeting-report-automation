...
- **Рекомендации адресованы Эмилии** (``mgmt_recommendations``), а не команде:
  как проводить встречи эффективнее, опираясь на то, где чек-лист просел. Этот
  блок теперь ВЫВОДИТСЯ в Telegram-отчёт.
...
- Рекомендации в конце адресуй ЭМИЛИИ (как проводить встречи лучше), не команде.
...
Коротко: <одно короткое предложение о сути встречи>
...
🎯 РЕКОМЕНДАЦИИ ЭМИЛИИ (как проводить встречи эффективнее)
  – <конкретный совет одной строкой>
  – <ещё один совет>
"""
